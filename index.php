...
<head>
    ...
    <style>
        @media screen and (max-width: 600px) {
            ...
            body {
                transform: rotate(90deg); /* Rotar la página en sentido horario */
                transform-origin: left top; /* Punto de rotación en la esquina superior izquierda */
                width: 100vh; /* Ancho basado en la altura de la pantalla */
                height: 100vw; /* Altura basada en el ancho de la pantalla */
				...
				?>
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							...
							<a href="fpdf/bcfexa_informes2.php" class="btn btn-success">INFORMES</a>
...
/// const DATE_FORMAT = "DD-MM-YYYY";
	...
	// Este link muestra como se busca por columna individual https://datatables.net/examples/api/multi_filter.html
				var dataTable = $('#lookup').DataTable( {
		  	   ...
		  	   "language":	{
					...
					"sInfoPostFix":    "",
					"sSearch":         "Buscar por <u>TEXTO COMPLETO</u>: ingrese al menos 3 letras. Para filtrar por <u>FECHA DE INICIO</u>, ingrese <b>FI</b> seguido del año a buscar (ej. FI2022). Para filtrar por <u>FECHA DE FIN</u>, ingrese <b>FF</b> seguido del año a buscar (ej. FI2025).<b>PRESIONE ENTER PARA BUSCAR</B>",
					"sUrl":            "",
					"sInfoThousands":  ",",
	...
	// controla que al menos se ingresen 3 letras y se presione la tecla enter			
