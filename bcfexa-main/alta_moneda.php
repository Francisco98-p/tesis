    ...
    <body>
			...
			?>
                    <div class="panel panel-default">
                        ...
                        <h3 class="panel-title"><i class="icon-user"></i> BCFEXA - Alta de Organización</h3> 
						 
                        </div>
						
                        <div class="panel-body">
							<div class="pull-right">
								<a href="nueva_organizacion.php" class="btn btn-sm btn-primary">Nueva Organización</a>
							</div><br>
							<hr>
