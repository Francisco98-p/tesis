...
<head>
    ...
    <body>
            ...
            <h3>BCFEXA - Agregar Unidad Ejecutora </h3>
                         ...
                         <form name="form1" id="form1" class="form-horizontal row-fluid"  action="nueva_unidadejecutora.php"  method="POST" >
																				
										<div class="control-group">
											<label class="control-label" for="extracto">Unidad Ejecutora en FCEFN</label>
											<div class="controls">
												<input name="unidad" id="unidad" class=" form-control span8 tip"   type="text" placeholder="Unidad de la FCEFN" required />
											</div>
										</div>
