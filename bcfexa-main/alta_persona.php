    ...
    <body>
			...
			?>
                    <div class="panel panel-default">
                        ...
                        <h3 class="panel-title"><i class="icon-user"></i> BCFEXA - Alta de Persona</h3> 
						 
                        </div>
						
                        <div class="panel-body">
							<div class="pull-right">
								<a href="nueva_persona.php" class="btn btn-sm btn-primary">Nueva Persona</a>
							</div><br>
							<hr>
	...
	// Este link muestra como se busca por columna individual https://datatables.net/examples/api/multi_filter.html
				var dataTable = $('#lookup').DataTable( {
		  	   ...
		  	   "language":	{
					...
					"sInfoPostFix":    "",
					"sSearch":         "Buscar por TEXTO COMPLETO :",
					"sUrl":            "",
					"sInfoThousands":  ",",
