...
-->
<?php
// Redirect root URL to the main index file explicitly
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body" id="detalleModalBody">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <p class="mt-2">Cargando detalles de la actividad...</p>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    ...
                                    <a href="#" id="detalleModalLink" class="btn btn-primary-custom">
                                        <i class="fas fa-external-link-alt me-2"></i>Ver en Página Completa
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        $(document).ready(function () {
            ...
            var dataTable = $('#lookup').DataTable({
                ...
                "drawCallback": function (settings) {
                    // Asegurar que los botones de acción tengan el estilo correcto después de cada redibujado
                    $('.action-btn').css({
                        'width': '32px',
                        'height': '32px',
                        'border-radius': '6px',
            ...
            window.openDetalleModal = function (id) {
                // Mostrar el modal
                $('#detalleModal').modal('show');

                // Actualizar el enlace para ver en página completa
                $('#detalleModalLink').attr('href', 'ver_detalle.php?id=' + id);

                // Cargar el contenido por AJAX
                $.ajax({
                    url: 'ver_detalle_modal.php',
                    type: 'GET',
                    data: { id: id },
                    beforeSend: function () {
                    ...
                    error: function () {
                        ...
                        $('#detalleModalBody').html(`
                            <div class="alert alert-danger" role="alert">
                                ...
                                Error al cargar los detalles de la actividad. Por favor, intente nuevamente.
                            </div>
                        `);
                    }
                });
