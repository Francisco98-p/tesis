...
-- Insertar valores de referencia con ID = 0 donde no existían
LOCK TABLES `ubicacionarchivo` WRITE;
INSERT INTO `ubicacionarchivo` (`Id`, `UbicacionOriginal`, `UbicacionCopia`, `UbicacionDigital`) VALUES (0, NULL, NULL, NULL);
UNLOCK TABLES;

LOCK TABLES `informe` WRITE;
INSERT INTO `informe` (`Id`, `InformeUnidad`, `FechaInformeUnidad`, `InformeOrganizacion`, `FechaInformeOrganizacion`, `InformeComision`, `FechaInformeComision`) VALUES (0, NULL, NULL, NULL, NULL, NULL, NULL);
UNLOCK TABLES;
...
INSERT INTO `actividad` VALUES (12,'R12/23','02-967-1-22','Convenio 123456','2022-08-25','2024-08-07','formalizar actividades Científicas, Técnicas ','Crear conciencia',8,0,0,0,0,2,2000,'Las actividades no implicarán erogación financiera alguna para las FACULTADES. Se contará con los tres casos',1,5000,'Cambiado otra vez',''),(13,'R51/21','02-1038-T-21','0','2021-09-07','2021-12-31','Se acordarán las condiciones del Servicio a Terceros (ST) solicitado por la EMPRESA a la FACULTAD, conducente a realizar la Descripción Petrográfica de muestras provistas por la EMPRESA, perteneciente','Descripción Petrográfica de cortes delgados correspondientes al proyecto minero Las Flechas y proyecto Evelina',1,0,0,0,0,1,120000,'El costo total del ST será de ciento veinte mil doscientos (120.200,00 pesos), incluyendo: 1) prepar',1,0,'El cronograma de actividades estará sujeto a la posibilidad de acceder al instrumental disponible en',''),(14,'R85/21','02-0805-A-21','Convenio Editado','2021-11-30','2025-11-30','La Facultad, a través del Departamento de Biología, y el Colegio, se comprometen a establecer como objeto de la presente Acta Complementaria es generar un marco de colaboración en actividades de mutuo interés por su trascendencia social, cultural y educativa de estudiantes y profesionales de las Ciencias Biológicas','. ',3,0,0,0,0,1,0,'Para la concreción de las acciones propuestas en la cláusula segunda las partes se comprometen a gestionar conjunta o separadamente ante otros organismos públicos y privados, nacionales e internacionales, los recursos financieros necesarios para la implementación de los mismos.',1,0,'.',''),(15,'55A23','02-0805-A-21','Canvenio 1','2023-06-01','2023-06-08','Resumen nuevo','',12,24,1,0,0,1,123456,'Nota monto organizacion',2,12345,'Todo en dolares x Exactas',''),(16,'R65/22','4','123','2022-08-16','2024-08-16','tiene por objeto formalizar actividades Científicas, Técnicas y de Extensión entre LAS FACULTADES en el marco del proyecto de extensión denominado “Geoparque Cerro de Valdivia: Acciones estratégicas participativas para su desarrollo”. Aprobado por Resolución -2022-32-APN-SECPU-ME como continuidad de Proyecto “Propuesta de Creación del Geoparque Cerro de Valdivia (Pocito). Una nueva alternativa al turismo tradicional','Sensibilizar a la comunidad mediante capacitaciones y talleres sobre la importancia del desarrollo de un abordaje técnico y responsable de la gastronomía como medio de desarrollo comunitario en el mar',1,24,1,0,0,1,0,'Sin erogaci´n',1,0,'Sin erogación','');
UNLOCK TABLES;
