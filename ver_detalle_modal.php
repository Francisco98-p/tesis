...
if(mysqli_num_rows($sql) == 0){
    echo "<div class='alert alert-warning'>No se encontraron detalles para esta actividad.</div>";
    exit;
}
...
<style>
    ...
    .modal-detail-custom .section-card {
    ...
    .modal-detail-custom .section-title {
    ...
    .modal-detail-custom .info-group {
        margin-bottom: 15px;
        padding: 10px;
        border-radius: 6px;
    ...
    .modal-detail-custom .info-label {
        font-weight: 600;
        color: var(--primary-color);
        margin-bottom: 5px;
    }
    
    .modal-detail-custom .info-value {
        font-size: 1rem;
        color: #333;
        padding: 8px 12px;
        background-color: white;
    ...
    .modal-detail-custom .badge-custom {
    ...
    .modal-detail-custom .text-area-custom {
        width: 100%;
        min-height: 100px;
    ...
    .modal-detail-custom .organization-section, .modal-detail-custom .unit-section {
    ...
    .modal-detail-custom .person-section {
    ...
    .modal-detail-custom .btn-pdf:hover {
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="info-group">
                    ...
                    ?>
                    <div class="info-value"><?php echo $tipo_actividad['Nombre'] ?? 'No especificado'; ?></div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="organization-section">
                    ...
                    <div class="info-group">
                        ...
                        <?php
                        $query_moneda_org = 'SELECT Nombre FROM monedadeinversion WHERE Id = ' . ($row['MonedaOrganizacion_Id'] ?: '0');
                        $result_moneda_org = mysqli_query($conn, $query_moneda_org);
                        $moneda_org = $result_moneda_org && mysqli_num_rows($result_moneda_org) > 0 ? mysqli_fetch_assoc($result_moneda_org) : ['Nombre' => 'No especificada'];
                        ?>
            ...
            <div class="col-md-6">
                <div class="unit-section">
                    ...
                    <div class="info-group">
                        <div class="info-label">Moneda</div>
                        <?php
                        $query_moneda_uni = 'SELECT Nombre FROM monedadeinversion WHERE Id = ' . ($row['MonedaUnidad_Id'] ?: '0');
                        $result_moneda_uni = mysqli_query($conn, $query_moneda_uni);
                        $moneda_uni = $result_moneda_uni && mysqli_num_rows($result_moneda_uni) > 0 ? mysqli_fetch_assoc($result_moneda_uni) : ['Nombre' => 'No especificada'];
                        ?>
