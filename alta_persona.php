...
if(isset($_GET['action']) && $_GET['action'] == 'delete') {
    ...
    $query = mysqli_query($conn, "SELECT * FROM persona WHERE Id='$id_delete'");
    if(mysqli_num_rows($query) == 0){
        ...
        $delete = mysqli_query($conn, "DELETE FROM persona WHERE Id='$id_delete'");
        if($delete){
                ...
                <div class="main-content">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h3 style="color: var(--primary-color);">
                            <i class="fas fa-user me-2"></i>Alta de Persona
                        </h3>
                        <a href="nueva_persona.php" class="btn btn-primary-custom">
    ...
    <script>
        $(document).ready(function() {
            ...
            var dataTable = $('#lookup').DataTable({
                ...
                "ajax": {
                    url: "ajax-persona.php", // json datasource
            ...
            window.confirmDelete = function(id) {
                Swal.fire({
                    title: '¿Estás seguro?',
                    text: "Esta acción no se puede deshacer y eliminará a la persona permanentemente.",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location.href = 'alta_persona.php?action=delete&id=' + id;
                    }
                });
            };
        });
