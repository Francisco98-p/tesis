...
<head>
    ...
    <body>
            ...
            <h3>BCFEXA - Agregar Personas </h3>
						 ...
						 action="nueva_persona.php"  method="POST" >
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												type="text" placeholder="Ingrese APELLIDO(s), Nombre(s) . Ej.: Olguin, Luis Alberto" required />
											</div>
										</div>
										 <div class="control-group">
											...
											<div class="controls">
												...
												type="text" placeholder="Indique el título que figura en la resolución"/>
											</div>
										</div> 
