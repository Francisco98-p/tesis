...
<head>
    ...
    <body>
			...
			?>
                    <div class="panel panel-default">
                        ...
                        <h3 class="panel-title"><i class="icon-user"></i> BCFEXA - Alta de Rol de la Persona</h3> 
						 
                        </div>
						
                        <div class="panel-body">
							<div class="pull-right">
								<a href="nueva_rol.php" class="btn btn-sm btn-primary">Nuevo Rol</a>
							</div><br>
							<hr>
	...
	// Este link muestra como se busca por columna individual https://datatables.net/examples/api/multi_filter.html
				...
				//			 ],
					...
					"ajax":{
						url :"ajax-rol.php", // json datasource
