...
if(!isset($_POST['searchTerm'])){
   ...
   $stmt = $db->prepare("SELECT * FROM palabras_claves ORDER BY palabra LIMIT :limit");
   ...
   // Mostrar resultados
   $stmt = $db->prepare("SELECT * FROM palabras_claves WHERE palabra like :nombre ORDER BY palabra LIMIT :limit");
