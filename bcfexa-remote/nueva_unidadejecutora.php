			...
			<div class="span12">
				<div class="content">
					...
					if (isset($_POST['input'])) {
						...
						// Verificar si la unidad ejecutora ya existe
						$check = mysqli_query($conn, "SELECT * FROM unidadejecutora WHERE Unidad = '$unidad'");
					...
					<form name="form1" id="form1" class="form-horizontal row-fluid" action="nueva_unidadejecutora.php"
						...
						<div class="control-group">
							<label class="control-label" for="extracto">Unidad Ejecutora en FCEFN</label>
							<div class="controls">
