...
if (isset($_GET['action']) && $_GET['action'] == 'delete') {
    ...
    $query = mysqli_query($conn, "SELECT * FROM organizacion WHERE Id='$id_delete'");
    if (mysqli_num_rows($query) == 0) {
        ...
        $delete = mysqli_query($conn, "DELETE FROM organizacion WHERE Id='$id_delete'");
        if ($delete) {
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="formNuevaOrganizacion">
                                            <div class="mb-3">
                                                <label for="nombreOrganizacion" class="form-label">Nombre de la
                                                    Organización</label>
                                                <input type="text" class="form-control" id="nombreOrganizacion"
                                                    name="nombre" placeholder="Ej.: Cámara Minera de San Juan" required>
                                            </div>
                                            <div id="errorMensaje" class="alert alert-danger d-none" role="alert"></div>
                                            <div id="successMensaje" class="alert alert-success d-none" role="alert">
                                            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            var dataTable = $('#lookup').DataTable({
                ...
                "ajax": {
                    url: "ajax-organizacion.php", // json datasource
