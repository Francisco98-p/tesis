                         ...
                         <form name="form1" id="form1" class="form-horizontal row-fluid" action="update-edit.php" method="POST" >
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<div class="controls">
											<select class="form-control" id="actividad" name="actividad" readonly tabindex="-1" style="width:600px;background-color:#DDFFFF" readonly tabindex="-1">
											<?php
											include "conn.php";
									  ...
									  <div id="tipo_organizacion" class="div-1">
									  	<div class="control-group">
											...
											<select class="form-control" name="organizacion1" id="organizacion1" required  readonly tabindex="-1" style="width:400px;background-color:#DDFFFF"">
