...
<head>
    ...
    <body>
			...
			if(isset($_POST['input'])){
				...
				$insert = mysqli_query($conn, "INSERT INTO rol(Id, Nombre) VALUES(NULL,'$nombre')"); 
            ...
            <blockquote>
            <h3>BCFEXA - Agregar Rol de las Personas </h3>
            </blockquote>
                         <form name="form1" id="form1" class="form-horizontal row-fluid"  
						 action="nueva_rol.php"  method="POST" >
																				
										<div class="control-group">
											<label class="control-label" for="extracto">Rol de la Persona</label>
											<div class="controls">
												<input name="nombre" id="nombre" class=" form-control span8 tip"   type="text" placeholder="Rol a desempeñar en la actividad" required />
											</div>
										</div>
