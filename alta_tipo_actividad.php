...
if(isset($_GET['action']) && $_GET['action'] == 'delete') {
    ...
    $query = mysqli_query($conn, "SELECT * FROM tipoactividad WHERE Id='$id_delete'");
    if(mysqli_num_rows($query) == 0){
        ...
        $delete = mysqli_query($conn, "DELETE FROM tipoactividad WHERE Id='$id_delete'");
        if($delete){
                ...
                <div class="main-content">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h3 style="color: var(--primary-color);">
                            <i class="fas fa-tasks me-2"></i>Alta de Tipo de Actividad
                        </h3>
                        <a href="nueva_tipoactividad.php" class="btn btn-primary-custom">
                            <i class="fas fa-plus-circle me-2"></i>Nuevo Tipo de Actividad
                        </a>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            window.confirmDelete = function(id) {
                Swal.fire({
                    title: '¿Estás seguro?',
                    text: "Esta acción no se puede deshacer y eliminará el tipo de actividad permanentemente.",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location.href = 'alta_tipo_actividad.php?action=delete&id=' + id;
                    }
                });
            };
        });
